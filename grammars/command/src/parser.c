...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [50] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_command_repeat1, 2), SHIFT_REPEAT(60),
  [53] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_command_repeat1, 2), SHIFT_REPEAT(69),
  [56] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_y, 1, .production_id = 1),
  [58] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_y, 1, .production_id = 1),
  [60] = {.entry = {.count = 1, .reusable = true}}, SHIFT(19),
  [62] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__originy, 1),
  [64] = {.entry = {.count = 1, .reusable = true}}, SHIFT(21),
  [66] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_svg, 1),
  [68] = {.entry = {.count = 1, .reusable = true}}, SHIFT(51),
  [70] = {.entry = {.count = 1, .reusable = true}}, SHIFT(48),
  [72] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__originx, 1),
  [74] = {.entry = {.count = 1, .reusable = true}}, SHIFT(22),
  [76] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_light, 3),
  [78] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_light, 3),
  [80] = {.entry = {.count = 1, .reusable = false}}, SHIFT(31),
  [82] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_geometry, 1),
  [84] = {.entry = {.count = 1, .reusable = true}}, SHIFT(56),
  [86] = {.entry = {.count = 1, .reusable = false}}, SHIFT(12),
  [88] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_y, 2, .production_id = 1),
  [90] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_y, 2, .production_id = 1),
  [92] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_absolute, 4, .production_id = 6),
  [94] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_absolute, 4, .production_id = 6),
  [96] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__originy, 2),
  [98] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__originx, 2),
  ...
  [106] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_output, 3),
  [108] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_output, 3),
  ...
  [118] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_input, 3),
  [120] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_input, 3),
  [122] = {.entry = {.count = 1, .reusable = false}}, SHIFT(43),
  [124] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__xy, 3),
  [126] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__xy, 3),
  ...
  [136] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_export, 2),
  [138] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_light, 4),
  [140] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_vertical, 4, .production_id = 4),
  [142] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 4),
  [144] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_output, 4),
  [146] = {.entry = {.count = 1, .reusable = true}}, SHIFT(58),
  [148] = {.entry = {.count = 1, .reusable = true}}, SHIFT(61),
  [150] = {.entry = {.count = 1, .reusable = true}}, SHIFT(57),
  [152] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_guide, 2),
  [154] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_origin, 5, .production_id = 5),
  [156] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_origin, 4),
  [158] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__exportable, 2),
  [160] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_horizontal, 3, .production_id = 3),
  [162] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_module, 3),
  [164] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_horizontal, 3),
  [166] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_input, 4),
  [168] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_anchor, 4, .production_id = 6),
  [170] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_module, 4),
  [172] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_set, 2),
  [174] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_new, 2),
  [176] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_svg, 2),
  [178] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_vertical, 3, .production_id = 3),
  [180] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_vertical, 3),
  [182] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_svg, 2, .production_id = 2),
  [184] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_horizontal, 4, .production_id = 4),
  [186] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_guide, 3),
  [188] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_vertical, 2),
  [190] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_guideline, 2, .production_id = 1),
  [192] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_geometry, 2),
  [194] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_horizontal, 2),
  ...
  [216] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_x, 1, .production_id = 1),
  ...
  [234] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_x, 2, .production_id = 1),
  [236] = {.entry = {.count = 1, .reusable = true}}, SHIFT(85),
  [238] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_text, 3),
