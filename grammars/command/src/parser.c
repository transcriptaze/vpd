...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 206:
      ...
      END_STATE();
    case 207:
      ACCEPT_TOKEN(aux_sym__anchor_token1);
      END_STATE();
    default:
      return false;
  }
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  [0] = {
    ...
    [aux_sym__anchor_token1] = ACTIONS(1),
  },
  [1] = {
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [38] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_command_repeat1, 2), SHIFT_REPEAT(42),
  [41] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_command_repeat1, 2), SHIFT_REPEAT(49),
  ...
  [72] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_horizontal, 3),
  [74] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_new, 2),
  [76] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_set, 2),
  [78] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_module, 4),
  [80] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_export, 2),
  [82] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_svg, 2),
  [84] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_horizontal, 4, .production_id = 3),
  [86] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_anchor, 4, .production_id = 5),
  ...
  [102] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_vertical, 4, .production_id = 3),
  [104] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_horizontal, 2),
  [106] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_origin, 5, .production_id = 4),
  [108] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_origin, 4),
  [110] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_horizontal, 3, .production_id = 2),
  [112] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__anchor, 4, .production_id = 5),
  [114] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__exportable, 2),
  [116] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_vertical, 2),
  ...
  [126] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_label, 3),
  [128] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_guideline, 2, .production_id = 1),
