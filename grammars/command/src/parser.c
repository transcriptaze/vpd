...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [38] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_command_repeat1, 2), SHIFT_REPEAT(38),
  [41] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_command_repeat1, 2), SHIFT_REPEAT(45),
  [44] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_y, 1),
  [46] = {.entry = {.count = 1, .reusable = true}}, SHIFT(9),
  [48] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_x, 1),
  [50] = {.entry = {.count = 1, .reusable = true}}, SHIFT(10),
  [52] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_y, 2),
  [54] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_x, 2),
  ...
  [66] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_vertical, 4, .production_id = 3),
  [68] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_horizontal, 3),
  [70] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_new, 2),
  ...
  [94] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_guide, 2),
  [96] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_geometry, 2),
  [98] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_horizontal, 2),
  [100] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_origin, 5, .production_id = 4),
  [102] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_origin, 4),
  [104] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_horizontal, 3, .production_id = 2),
  [106] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_svg, 2),
  [108] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_vertical, 2),
  [110] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_guide, 3),
  [112] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_vertical, 3, .production_id = 2),
  [114] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_label, 3),
  [116] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_vertical, 3),
  [118] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_guideline, 2, .production_id = 1),
  ...
  [148] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_text, 3),
