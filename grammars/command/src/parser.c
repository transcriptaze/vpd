...
static const uint32_t ts_small_parse_table_map[] = {
  ...
  [SMALL_STATE(109)] = 1004,
  [SMALL_STATE(110)] = 1008,
  [SMALL_STATE(111)] = 1012,
  [SMALL_STATE(112)] = 1016,
  [SMALL_STATE(113)] = 1020,
  [SMALL_STATE(114)] = 1024,
  [SMALL_STATE(115)] = 1028,
};
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [61] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_command_repeat1, 2), SHIFT_REPEAT(69),
  [64] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_command_repeat1, 2), SHIFT_REPEAT(83),
  [67] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_command, 1),
  [69] = {.entry = {.count = 1, .reusable = true}}, SHIFT(8),
  [71] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__component, 4),
  [73] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__component, 4),
  ...
  [85] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__string, 3),
  [87] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__originx, 1),
  [89] = {.entry = {.count = 1, .reusable = true}}, SHIFT(22),
  [91] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__originy, 1),
  [93] = {.entry = {.count = 1, .reusable = true}}, SHIFT(21),
  [95] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__component, 2),
  [97] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__component, 2),
  [99] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name, 1),
  [101] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name, 1),
  ...
  [109] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_absolute, 4, .production_id = 7),
  [111] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_absolute, 4, .production_id = 7),
  [113] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relative, 3, .production_id = 4),
  [115] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relative, 3, .production_id = 4),
  [117] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__originy, 2),
  [119] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__originx, 2),
  [121] = {.entry = {.count = 1, .reusable = true}}, SHIFT(32),
  [123] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_background, 2),
  ...
  [131] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_y, 2, .production_id = 1),
  [133] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_y, 2, .production_id = 1),
  [135] = {.entry = {.count = 1, .reusable = true}}, SHIFT(100),
  [137] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_vertical, 3, .production_id = 3),
  ...
  [161] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__component, 5),
  [163] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__component, 3),
  [165] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_origin, 5, .production_id = 6),
  [167] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_module, 4),
  [169] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__exportable, 2),
  [171] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_horizontal, 4, .production_id = 5),
  [173] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_module, 3),
  [175] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_vertical, 4, .production_id = 5),
  [177] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_label, 5),
  [179] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_part, 1),
  [181] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_label, 3),
  [183] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_background, 4),
  [185] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_origin, 4),
  [187] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_vertical, 2),
  [189] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_horizontal, 3, .production_id = 3),
  [191] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_horizontal, 2),
  [193] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_geometry, 2),
  [195] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_guideline, 2, .production_id = 1),
  [197] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_horizontal, 3),
  ...
  [209] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_svg, 2, .production_id = 2),
  [211] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_svg, 2),
  ...
  [257] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_x, 1, .production_id = 1),
  ...
  [269] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_x, 2, .production_id = 1),
