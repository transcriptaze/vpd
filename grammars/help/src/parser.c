...
enum {
  ...
  sym_widget = 84,
  sym_label = 85,
  sym__label_string = 86,
  sym__label_absolute = 87,
  sym__label_relative = 88,
  sym__label_geometry = 89,
  sym_font = 90,
  sym_fontsize = 91,
  sym_halign = 92,
  sym_valign = 93,
...
static const uint32_t ts_small_parse_table_map[] = {
  ...
  [SMALL_STATE(123)] = 1678,
  [SMALL_STATE(124)] = 1682,
  [SMALL_STATE(125)] = 1686,
  [SMALL_STATE(126)] = 1690,
  [SMALL_STATE(127)] = 1694,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [56] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_command_repeat1, 2), SHIFT_REPEAT(7),
  [59] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_command_repeat1, 2), SHIFT_REPEAT(23),
  [62] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_command_repeat1, 2), SHIFT_REPEAT(3),
  [65] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_command_repeat1, 2), SHIFT_REPEAT(34),
  [68] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_command_repeat1, 2), SHIFT_REPEAT(12),
  [71] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_command_repeat1, 2), SHIFT_REPEAT(31),
  [74] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__label_string, 1),
  [76] = {.entry = {.count = 1, .reusable = true}}, SHIFT(124),
  [78] = {.entry = {.count = 1, .reusable = true}}, SHIFT(123),
  [80] = {.entry = {.count = 1, .reusable = true}}, SHIFT(108),
  [82] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_set, 1),
  [84] = {.entry = {.count = 1, .reusable = true}}, SHIFT(20),
  [86] = {.entry = {.count = 1, .reusable = true}}, SHIFT(9),
  [88] = {.entry = {.count = 1, .reusable = true}}, SHIFT(8),
  [90] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_background, 1),
  [92] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_background, 1),
  [94] = {.entry = {.count = 1, .reusable = false}}, SHIFT(15),
  [96] = {.entry = {.count = 1, .reusable = false}}, SHIFT(54),
  [98] = {.entry = {.count = 1, .reusable = true}}, SHIFT(55),
  [100] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_origin, 1),
  [102] = {.entry = {.count = 1, .reusable = true}}, SHIFT(48),
  [104] = {.entry = {.count = 1, .reusable = true}}, SHIFT(17),
  [106] = {.entry = {.count = 1, .reusable = true}}, SHIFT(16),
  [108] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_valign, 1),
  [110] = {.entry = {.count = 1, .reusable = false}}, SHIFT(39),
  [112] = {.entry = {.count = 1, .reusable = true}}, SHIFT(39),
  [114] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_fontsize, 1),
  [116] = {.entry = {.count = 1, .reusable = true}}, SHIFT(59),
  [118] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_save, 1),
  [120] = {.entry = {.count = 1, .reusable = true}}, SHIFT(13),
  [122] = {.entry = {.count = 1, .reusable = true}}, SHIFT(37),
  [124] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_project, 1),
  ...
  [134] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name, 1),
  [136] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_y, 1, .production_id = 3),
  [138] = {.entry = {.count = 1, .reusable = true}}, SHIFT(43),
  [140] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_x, 1, .production_id = 3),
  [142] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__y, 1),
  [144] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__y, 1),
  [146] = {.entry = {.count = 1, .reusable = true}}, SHIFT(50),
  [148] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_label, 1),
  [150] = {.entry = {.count = 1, .reusable = true}}, SHIFT(114),
  [152] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__module_attr, 1),
  ...
  [164] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__label_geometry, 3),
  [166] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__label_geometry, 3),
  [168] = {.entry = {.count = 1, .reusable = false}}, SHIFT(28),
  [170] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_decorate, 1),
  [172] = {.entry = {.count = 1, .reusable = true}}, SHIFT(105),
  [174] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__label_relative, 3),
  [176] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__label_relative, 3),
  [178] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_svg, 1),
  [180] = {.entry = {.count = 1, .reusable = true}}, SHIFT(91),
  [182] = {.entry = {.count = 1, .reusable = true}}, SHIFT(92),
  [184] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__label_absolute, 4),
  [186] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__label_absolute, 4),
  [188] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_module, 2),
  [190] = {.entry = {.count = 1, .reusable = true}}, SHIFT(46),
  [192] = {.entry = {.count = 1, .reusable = false}}, SHIFT(72),
  [194] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_font, 1),
  ...
  [202] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_panel, 1),
  [204] = {.entry = {.count = 1, .reusable = true}}, SHIFT(25),
  [206] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_export, 1),
  [208] = {.entry = {.count = 1, .reusable = true}}, SHIFT(30),
  [210] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__component, 3),
  [212] = {.entry = {.count = 1, .reusable = true}}, SHIFT(118),
  [214] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_origin, 3),
  ...
  [222] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__light_id, 1),
  [224] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__light_id, 1),
  ...
  [232] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_y, 2, .production_id = 3),
  ...
  [244] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__parameter_id, 1),
  [246] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__parameter_id, 1),
  [248] = {.entry = {.count = 1, .reusable = false}}, SHIFT(65),
  [250] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_x, 2, .production_id = 3),
  [252] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_offset, 1),
  [254] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__output_id, 1),
  [256] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__output_id, 1),
  [258] = {.entry = {.count = 1, .reusable = false}}, SHIFT(64),
  [260] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_absolute, 2, .production_id = 4),
  [262] = {.entry = {.count = 1, .reusable = true}}, SHIFT(49),
  [264] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_module, 3),
  ...
  [274] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_absolute, 1),
  [276] = {.entry = {.count = 1, .reusable = true}}, SHIFT(45),
  [278] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_absolute, 3, .production_id = 4),
  ...
  [286] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__save_options, 1),
  [288] = {.entry = {.count = 1, .reusable = true}}, SHIFT(115),
  [290] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_origin, 2),
  [292] = {.entry = {.count = 1, .reusable = true}}, SHIFT(35),
  [294] = {.entry = {.count = 1, .reusable = true}}, SHIFT(33),
  [296] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rgb, 1),
  [298] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rgba, 1),
  [300] = {.entry = {.count = 1, .reusable = true}}, SHIFT(116),
  [302] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_background, 2),
  [304] = {.entry = {.count = 1, .reusable = true}}, SHIFT(109),
  [306] = {.entry = {.count = 1, .reusable = true}}, SHIFT(113),
  [308] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_halign, 1),
  [310] = {.entry = {.count = 1, .reusable = true}}, SHIFT(106),
  [312] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__light_id, 2),
  [314] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_guide, 1),
  [316] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__input_id, 2),
  [318] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__output_id, 2),
  [320] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__parameter_id, 2),
  [322] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__guideline_id, 2),
  [324] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_project, 2),
  [326] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_script, 2),
  [328] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_colour, 3),
  [330] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_panel, 2),
  [332] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_input, 1),
  [334] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_valign, 2),
  [336] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_halign, 3),
  [338] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_output, 1),
  [340] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_fontsize, 2),
  [342] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__label_string, 2),
  [344] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 1),
  [346] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__module_attr, 3),
  [348] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_font, 2),
  [350] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_light, 1),
  [352] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_label, 2),
  [354] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__label_absolute, 5),
  [356] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_export, 2),
  [358] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_save, 2),
  [360] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_decoration, 3),
  [362] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__label_geometry, 4),
  [364] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_load, 2, .production_id = 2),
  [366] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_widget, 1),
  [368] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__label_relative, 4),
  [370] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_svg, 2, .production_id = 5),
  [372] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_svg, 2),
  [374] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_module, 4),
  [376] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_load, 2, .production_id = 1),
  [378] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_new, 2),
  [380] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_absolute, 4, .production_id = 6),
  [382] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_set, 2),
  [384] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_delete, 2),
  [386] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_origin, 4),
  [388] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_background, 4),
  [390] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_decorate, 2),
  [392] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__component, 4),
  [394] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__save_options, 3),
  ...
  [404] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__x, 1),
