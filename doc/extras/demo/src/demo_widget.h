...
const auto DEMO_INPUT_PJ301M = mm2px(Vec(35.56, 25.4));
...
const auto DEMO_LIGHT_YELLOW = mm2px(Vec(33.02, 93.48));
const auto DEMO_LIGHT_GREEN = mm2px(Vec(25.4, 91.44));
const auto DEMO_LIGHT_BLUE = mm2px(Vec(17.78, 93.48));
const auto DEMO_LIGHT_INDIGO = mm2px(Vec(12.2, 99.06));
const auto DEMO_LIGHT_VIOLET = mm2px(Vec(10.16, 106.68));
